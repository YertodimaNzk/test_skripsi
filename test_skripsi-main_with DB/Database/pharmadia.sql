...
CREATE TABLE `keyword` (
  ...
  `created_by` varchar(200) NOT NULL,
  `updated_by` varchar(200) NOT NULL,
  PRIMARY KEY (`keyword_id`,`id_penyakit`,`auth_id`),
  KEY `fk_keyword_penyakit1_idx` (`id_penyakit`,`auth_id`),
  CONSTRAINT `fk_keyword_penyakit1` FOREIGN KEY (`id_penyakit`, `auth_id`) REFERENCES `penyakit` (`penyakit_id`, `auth_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
